...
if(mysqli_num_rows($result_content)!=1){
	skip('index.php', 'error', '本帖子不存在!');exit();
}
	...
	<div class="wrapContent">
		...
		<div class="right">
			<div class="pubdate">
				...
				<span class="floor"><?php echo $i++?>楼&nbsp;|&nbsp;<a target="_blank" href="quote.php?id=<?php echo $_GET['id']?>&reply_id=<?php echo $data_reply['id']?>">引用</a>|&nbsp;<a target="_blank" href="reply_delete.php?id=<?php echo $_GET['id']?>&reply_id=<?php echo $data_reply['id']?>">删除</a></span>
			</div>
			<div class="content">
				<?php 
